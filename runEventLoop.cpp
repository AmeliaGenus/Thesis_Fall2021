...
C
  PlotUtils::Cutter<CVUniverse, MichelEvent>::truth_t signalDefinition, phaseSpac:e
;
//these are cuts on reconstructed quantitues that must be applied to data and MC alike
